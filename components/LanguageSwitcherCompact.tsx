...
export function LanguageSwitcherCompact() {
  ...
  const handleLanguageChange = (newLocale: string) => {
    ...
    // Log current state
    console.log('[LanguageSwitcherCompact] Changing language:', {
    ...
    console.log('[LanguageSwitcherCompact] Cookies set:', {
    ...
    startTransition(() => {
      console.log('[LanguageSwitcherCompact] Navigating to:', {
        pathname,
        newLocale,
      ...
      setTimeout(() => {
        console.log('[LanguageSwitcherCompact] After navigation:', {
          currentUrl: window.location.href,
          cookiesAfter: document.cookie,
