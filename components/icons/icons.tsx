...
export const WorkflowsIcon = ({ size = 21, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox='0 0 21 21'
  ...
  >
    <path
      d='M6.48767 6.63479V5.79571C6.48767 3.8494 8.05338 1.93768 9.9997 1.75602C12.318 1.53111 14.2729 3.35633 14.2729 5.63136V6.8251'
      stroke='currentColor'
      strokeWidth='0.865031'
      strokeMiterlimit='10'
      strokeLinecap='round'
      strokeLinejoin='round'
    />
    <path
      d='M7.78529 19.0307H12.9755C16.4529 19.0307 17.0757 17.638 17.2574 15.9425L17.9062 10.7523C18.1397 8.64167 17.5342 6.92026 13.8405 6.92026H6.92026C3.22658 6.92026 2.62106 8.64167 2.85462 10.7523L3.50339 15.9425C3.68504 17.638 4.30787 19.0307 7.78529 19.0307Z'
      stroke='currentColor'
      strokeWidth='0.865031'
      strokeMiterlimit='10'
      strokeLinecap='round'
      strokeLinejoin='round'
    />
    <path d='M13.4041 10.3804H13.4119' stroke='currentColor' strokeWidth='0.865031' strokeLinecap='round' strokeLinejoin='round' />
    <path d='M7.34805 10.3804H7.35582' stroke='currentColor' strokeWidth='0.865031' strokeLinecap='round' strokeLinejoin='round' />
  </svg>
);

export const ExecutionIcon = ({ size = 21, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox='0 0 21 21'
  ...
  >
    <path
      d='M7.78532 19.0307H12.9755C17.3007 19.0307 19.0307 17.3006 19.0307 12.9755V7.78529C19.0307 3.46013 17.3007 1.73007 12.9755 1.73007H7.78532C3.46016 1.73007 1.7301 3.46013 1.7301 7.78529V12.9755C1.7301 17.3006 3.46016 19.0307 7.78532 19.0307Z'
      stroke='currentColor'
      strokeWidth='0.865031'
      strokeLinecap='round'
      strokeLinejoin='round'
    />
    <path
      d='M13.4079 16.0031C14.3595 16.0031 15.138 15.2245 15.138 14.273V6.48772C15.138 5.53619 14.3595 4.75766 13.4079 4.75766C12.4564 4.75766 11.6779 5.53619 11.6779 6.48772V14.273C11.6779 15.2245 12.4477 16.0031 13.4079 16.0031Z'
      stroke='currentColor'
      strokeWidth='0.865031'
      strokeLinecap='round'
      strokeLinejoin='round'
    />
    <path
      d='M7.35274 16.0031C8.30428 16.0031 9.0828 15.2246 9.0828 14.273V11.2454C9.0828 10.2939 8.30428 9.51535 7.35274 9.51535C6.40121 9.51535 5.62268 10.2939 5.62268 11.2454V14.273C5.62268 15.2246 6.39256 16.0031 7.35274 16.0031Z'
      stroke='currentColor'
      strokeWidth='0.865031'
      strokeLinecap='round'
      strokeLinejoin='round'
...
export const BalanceIcon = ({ size = 21, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox='0 0 21 21'
  ...
  >
    <path
      d='M13 8.83333C13 10.3674 10.2017 11.6111 6.75 11.6111C3.29822 11.6111 0.5 10.3674 0.5 8.83333M13 8.83333C13 7.29921 10.2017 6.05556 6.75 6.05556C3.29822 6.05556 0.5 7.29921 0.5 8.83333M13 8.83333V13.2778M0.5 8.83333V13.2778M13 13.2778C13 14.8119 10.2017 16.0556 6.75 16.0556C3.29822 16.0556 0.5 14.8119 0.5 13.2778M13 13.2778V17.7222C13 19.2563 10.2017 20.5 6.75 20.5C3.29822 20.5 0.5 19.2563 0.5 17.7222V13.2778M20.5 3.27778C20.5 1.74366 17.7018 0.5 14.25 0.5C11.7761 0.5 9.638 1.13881 8.625 2.06552M20.5 3.27778C20.5 4.30594 19.2431 5.20364 17.375 5.68393M20.5 3.27778V12.7222C20.5 13.5448 19.2431 14.2629 17.375 14.6471M20.5 8.27778C20.5 9.11856 19.1869 9.85022 17.2499 10.2278'
      stroke='currentColor'
      strokeLinecap='round'
      strokeLinejoin='round'
    />
...
export const SettingsNewIcon = ({ size = 21, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox='0 0 21 21'
  ...
  >
    <path
      d='M18.1329 11.4766C18.1766 11.1527 18.2 10.8266 18.2031 10.5C18.2 10.1734 18.1766 9.84728 18.1329 9.52344L20.303 7.86817C20.401 7.79524 20.468 7.68968 20.4911 7.57167C20.5142 7.45366 20.4919 7.33148 20.4283 7.22852L18.3735 3.75685C18.314 3.65272 18.2174 3.57339 18.102 3.53382C17.9866 3.49424 17.8604 3.49716 17.747 3.54201L15.186 4.54787C14.6531 4.15162 14.0704 3.82343 13.4519 3.57131L13.066 0.919945C13.049 0.802622 12.9888 0.695333 12.8966 0.618073C12.8044 0.540814 12.6865 0.498858 12.5649 0.500024H8.44517C8.32356 0.498858 8.20566 0.540814 8.11345 0.618073C8.02124 0.695333 7.96101 0.802622 7.94399 0.919945L7.55809 3.57131C6.93888 3.82186 6.35592 4.15016 5.82401 4.54787L3.25297 3.54201C3.13962 3.49716 3.01336 3.49424 2.89796 3.53382C2.78257 3.57339 2.68601 3.65272 2.6265 3.75685L0.571666 7.22852C0.508122 7.33148 0.48577 7.45366 0.508886 7.57167C0.532002 7.68968 0.598963 7.79524 0.696961 7.86817L2.86205 9.52344C2.81856 9.84729 2.79513 10.1734 2.79188 10.5C2.79496 10.8266 2.81839 11.1527 2.86205 11.4766L0.696961 13.1318C0.598963 13.2048 0.532002 13.3103 0.508886 13.4283C0.48577 13.5463 0.508122 13.6685 0.571666 13.7715L2.6265 17.2431C2.68601 17.3473 2.78257 17.4266 2.89796 17.4662C3.01336 17.5058 3.13962 17.5028 3.25297 17.458L5.81399 16.4521C6.34689 16.8484 6.92965 17.1766 7.54806 17.4287L7.93397 20.0801C7.95099 20.1974 8.01122 20.3047 8.10343 20.3819C8.19564 20.4592 8.31353 20.5011 8.43515 20.5H12.5448C12.6664 20.5011 12.7843 20.4592 12.8765 20.3819C12.9687 20.3047 13.029 20.1974 13.046 20.0801L13.4319 17.4287C14.0511 17.1781 14.6341 16.8498 15.166 16.4521L17.727 17.458C17.8403 17.5028 17.9666 17.5058 18.082 17.4662C18.1974 17.4266 18.2939 17.3473 18.3535 17.2431L20.4083 13.7715C20.4718 13.6685 20.4942 13.5463 20.4711 13.4283C20.448 13.3103 20.381 13.2048 20.283 13.1318L18.1329 11.4766ZM10.5 14.0059C9.78808 14.0068 9.09186 13.802 8.49944 13.4174C7.90702 13.0327 7.44502 12.4855 7.17189 11.845C6.89876 11.2045 6.82678 10.4994 6.96506 9.81904C7.10335 9.13865 7.44567 8.51351 7.94872 8.02272C8.45178 7.53193 9.09295 7.19754 9.79112 7.06187C10.4893 6.9262 11.2131 6.99535 11.8709 7.26055C12.5287 7.52576 13.091 7.97511 13.4866 8.55175C13.8823 9.12839 14.0934 9.8064 14.0934 10.5C14.0941 10.9602 14.0016 11.4159 13.8214 11.8413C13.6411 12.2666 13.3765 12.6531 13.0427 12.9787C12.709 13.3043 12.3126 13.5626 11.8763 13.7389C11.44 13.9151 10.9723 14.0059 10.5 14.0059Z'
      stroke='currentColor'
      strokeLinecap='round'
      strokeLinejoin='round'
    />
...
export const ExternalLinkIcon = ({ size = 24, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
// Flag Icons
export const USFlagIcon: React.FC<IconSvgProps> = ({ className = 'w-5 h-4', ...props }) => (
  <svg
    className={className}
    viewBox="0 0 640 480"
    xmlns="http://www.w3.org/2000/svg"
...
export const UkraineFlagIcon: React.FC<IconSvgProps> = ({ className = 'w-5 h-4', ...props }) => (
  <svg
    className={className}
    viewBox="0 0 640 480"
    xmlns="http://www.w3.org/2000/svg"
...
export const FranceFlagIcon: React.FC<IconSvgProps> = ({ className = 'w-5 h-4', ...props }) => (
  <svg
    className={className}
    viewBox="0 0 640 480"
    xmlns="http://www.w3.org/2000/svg"
...
export const RussiaFlagIcon: React.FC<IconSvgProps> = ({ className = 'w-5 h-4', ...props }) => (
  <svg
    className={className}
    viewBox="0 0 640 480"
    xmlns="http://www.w3.org/2000/svg"
