    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">Please sign in to access execution history.</p>
          <Link
            href="/"
  ...
  return (
    <div className='min-h-screen bg-gray-900'>
      ...
      <div className='md:hidden bg-gray-900'>
        <div className="p-4">
          <h1 className="text-xl font-bold mb-4 text-white">Executions</h1>
          <p className="text-gray-300">Execution history is under development for mobile.</p>
        </div>
      </div>
    </div>
  );
